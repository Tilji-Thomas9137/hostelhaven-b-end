...
SELECT 
    ...
    true
FROM users u
LEFT JOIN room_allocations ra ON ra.user_id = u.id AND ra.status = 'active'
...
/*
-- Example 1: Create a new outpass request
SELECT create_outpass_request(
    'user-uuid-here',
...
-- Example 2: Get student's outpass requests
SELECT * FROM get_student_outpass_requests('user-uuid-here');

-- Example 3: Get all pending requests (for wardens)
SELECT * FROM get_pending_outpass_requests();

-- Example 4: Approve an outpass request
SELECT update_outpass_status(
    'outpass-uuid-here',
    'approved',
    'warden-uuid-here'
);

-- Example 5: Reject an outpass request
SELECT update_outpass_status(
    'outpass-uuid-here',
    'rejected',
    'warden-uuid-here',
...
-- Example 6: Mark student as returned
SELECT mark_student_returned('outpass-uuid-here');
*/
